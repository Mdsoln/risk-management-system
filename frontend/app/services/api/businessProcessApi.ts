 ...
 */
export const getBusinessProcessById = async (id: string): Promise<BusinessProcessPojo> => {
 ...
 */
export const addBusinessProcess = async (dto: BusinessProcessDTO): Promise<BusinessProcessPojo> => {
...
export const getBusinessProcessesByFundObjective = async (
    ...
    const response = await axios.get(`${BASE_URL}/by-fund-objective/${fundObjectiveId}`);
    return response.data.data; // Assuming the data is inside the `data` field
};
 ...
 * Search Business Processes by Name.
 */
export const searchBusinessProcesses = async (name: string): Promise<BusinessProcessPojo[]> => {
