...
import tz.go.psssf.risk.compliance.service.ComplianceDocumentService;
...
@Path("/api/v1/compliance/document")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class ComplianceDocumentResource {
    ...
    @GET
    @Path("/list")
    public ResponseWrapper<PaginatedResponse<ComplianceDocumentPojo>> listAll(
    ...
    @GET
    @Path("/{id}")
    public ResponseWrapper<ComplianceDocumentPojo> getById(@PathParam("id") String id) {
    ...
    @PUT
    @Path("/{id}")
    public ResponseWrapper<ComplianceDocumentPojo> update(@PathParam("id") String id, @Valid ComplianceDocumentDTO dto) {
