...
import tz.go.psssf.risk.service.MeasurementService;
...
public class MeasurementResource {
    ...
    @GET
    @Path("/{id}")
    public ResponseWrapper<MeasurementPojo> getMeasurementById(@ValidPathParam @PathParam("id") String id) {
        try {
    ...
    @PUT
    @Path("/{id}")
    public ResponseWrapper<MeasurementPojo> update(@ValidPathParam @PathParam("id") String id, @Valid MeasurementDTO measurementDTO) {
        try {
