...
import tz.go.psssf.risk.service.UserService;
...
public class UserResource {
    ...
    @GET
    @Path("/{id}")
    public ResponseWrapper<UserPojo> getUserById(@ValidPathParam @PathParam("id") String id) {
        try {
...
//    @GET
//    @Path("/nin/{nin}")
//    public ResponseWrapper<UserPojo> getUserByNin(@ValidPathParam @PathParam("nin") String nin) {
//        try {
//            return userService.findByNin(nin);
//        } catch (Exception e) {
//            return ResponseHelper.createErrorResponse(e);
//        }
//    }
//    
    @GET
    @Path("/nin/{nin}")
    public ResponseWrapper<UserPojo> getUserByNin( @PathParam("nin") String nin) {
        try {
            return userService.findByNin(nin);
        } catch (Exception e) {
            return ResponseHelper.createErrorResponse(e);
    ...
    @PUT
    @Path("/{id}")
    public ResponseWrapper<UserPojo> update(@ValidPathParam @PathParam("id") String id, @Valid UserDTO userDTO) {
        try {
