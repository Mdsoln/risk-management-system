...
import tz.go.psssf.risk.bcm.service.StatusReportService;
...
public class StatusReportResource {
    ...
    @GET
    @Path("/list")
    public ResponseWrapper<PaginatedResponse<StatusReportPojo>> listAll(
    ...
    @GET
    @Path("/{id}")
    public ResponseWrapper<StatusReportPojo> getById(@PathParam("id") String id) {
    ...
    @PUT
    @Path("/{id}")
    public ResponseWrapper<StatusReportPojo> update(@PathParam("id") String id, @Valid StatusReportDTO dto) {
